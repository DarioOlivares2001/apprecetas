...
public class HomeController {
    ...
    public String detallereceta(@RequestParam(name="name", required=false, defaultValue="Juan González") String name, Model model) {
        System.out.println("Name: " + name);
        String url = "http://localhost:8082/api/recetas/buscar?nombre=Paella";
